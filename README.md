...
| M2 | 2 NVME PCI-E 3.0 x4 1x PCI-E 2.0 x4 1x M2 PCI-E 2.0 x2 Wifi | Поддержка Sata M2 SSD неизвестна, Средний порт линии PCI-E от чипсета поэтому он будет работать медленнее, поддерживаемые размеры 2242, 2260, 2280 за исключением самого мелкого и нижнего M2, помимо этого в данный(самый нижний) разъём можно установить только M2 WIFI/WIFI+Bluetooth, самые свежие WIFI 6E 802.11ax упрутся в пропускную способность шины PCI-E 2.0 x2 , miniPCI-E/MSata WIFI/SSD туда не установить |
| Питание | 1x 24PIN, 1x 8PIN |  |
| Порты расширений | 3xPCI-E 3.0 x16(в металлическом обрамлении), 2xPCI-E x1 3.0 | Возможно не все X16/X1 имеют скорость 3.0, смотря куда они подключены, если CPU то 3.0, если Чипсет то 2.0  |
...
| Звук | Realtek ALC892 |  |
| Sata | 8xSata 3.0(6Gb/S) из них 6(неизвестно какие) поддерживают Intel RAID 0/1/5/10 |  | 
| M2 | 2 NVME PCI-E 3.0 x4 1x PCI-E 3.0 x2 1x M2 Wifi | Поддержка Sata M2 SSD неизвестна, Средний порт имеет меньше линий PCI-E поэтому он будет работать медленнее, поддерживаемые размеры 2242, 2260, 2280 за исключением самого мелкого и нижнего M2, помимо этого в данный(самый нижний) разъём можно установить только M2 WIFI/WIFI+Bluetooth, miniPCI-E/MSata туда не установить |
| Питание | 1x 24PIN, 1x 8PIN |  |
| Порты расширений | 3xPCI-E 3.0 x16(в металлическом обрамлении), 2xPCI-E x1 3.0 | Возможно не все X16/X1 имеют скорость 3.0, смотря куда они подключены, если CPU то 3.0, если Чипсет то 2.0  |
| I/O порты(Задние) | 2XPS/2(клавиатура и мышь) 4xUSB 2.0 4xUSB 3.0 1x RJ45 6x7.1 Звук(Микрофон, Наушники/Колонки, Линейный вход, SPDIF, REAR(Задний), C.SUB(сабвуфер)) |  |
| Выносные колодни(передние/дополнительные задние порты) | 1x звук, 1xUSB 3.0, 2xUSB 2.0,1x COM | Дополнительно отмечу наличие POST-кодера, Speaker, кнопки включения и Reset |
