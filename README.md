...
| Форм-фактор и размеры | **Не ATX** 304x300 мм  |  |
...
| VRM | 5 фаз |  |
| Чипсет | C612 | |
| Память | **Возможно** 8x DDR4 UDIMM/ECC/ECC REG/ | Т.Е Подходит как и серверная, так и обычная память, поддержка LRDIMM незивестна |
| Канальность | 4+4 канала, "8 каналов" |  |
| Частоты памяти | **Возможно** DDR4: 1866/2133/2400 |  |
| Подключение вентиляторов | 4=2x 3PIN+2x 4PIN |  |
| Сеть | **Точно неизвестно, но вероятнее всего** Realtek RTL8111H 1000/100/10 Mbit  |  |
| Звук | **Точно неизвестно, но вероятнее всего** Realtek ALC887/662/892 |  |
...
| Особенности | Имеется интегрированная в плату видеокарта Aspeed AST2300/2400/2500, не для игр не предназначена, максимум вывод изображения рабочего стола и настройка, возможно будет наличие IPMI |  |
