 ...
 **Hewlett Packard Enterprise/HP/HPE**
 ...
 Популярные платы от HP это HP Z440 и Z640. Различия у данных плат только в том что платы Z440 имеет сразу 8 слотов памяти, а Z640 только 4 слота но имеет порт для перпендикулярного подключения дочерней платы с 2 CPU и 4 слотами памяти.
