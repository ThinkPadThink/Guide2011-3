...
| Максимальный поддерживаемы объём памяти | 64Gb | Скорее всего не так, зависит от типа памяти |
...
| Максимальный поддерживаемы объём памяти | 32Gb | Скорее всего не так, зависит от типа памяти |
...
| Максимальный поддерживаемы объём памяти | 128Gb | Скорее всего не так, зависит от типа памяти |
| Подключение вентиляторов | 5=3x 3PIN+2x 4PIN |  |
| Сеть | Realtek RTL8111H 1000/100/10 Mbit |  |
| Звук | Realtek ALC892 |  |
...
| I/O порты(Задние) | 2XPS/2(клавиатура и мышь) 4xUSB 2.0 4xUSB 3.0 1x RJ45 3x7.1 Звук(Микрофон, Наушники/Колонки, Линейный вход, SPDIF, REAR(Задний), C.SUB(сабвуфер)) |  |
...
|---|---|---|
| UEFI/BIOS | Классический AMI | Модбиос для разблокировки турбобуста на все ядра и поддержкой разгона процессоров с разблокированным множителем [тут]() |
 ...
 **PlexHD X99 DDR4 aka ZX_99EV3_V1.21:** 
 ...
 Плата с X99/C612 чипсетом. Звук: Realtek ALC662/892(анон), Сеть RTL8111/8168/8411 M2 NVME PCI-E 3.0 X4 . 
