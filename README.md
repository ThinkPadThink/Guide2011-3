...
| Примечание | Осенью 2019 стали появляться версии платы с кожухом во весь левый край платы, с подсветкой |  |
...
| Примечание | Описание на сайте [HUANAZHI](http://www.huananzhi.com/html/1/149/150/349.html), Не все процессоры будут работат с DDR3 памятью, DDR3 и DDR4 память вместе работать не будет | Заглушка задней панели I/O интегрирована сразу в кожух платы |
| Форм-фактор и размеры | ATX 283x215 мм  |  |
...
| Чипсет | C612 | |
| Память |  DDR3 UDIMM/ECC/ECC REG/ DDR4 UDIMM/ECC/ECC REG/ | Т.Е Подходит как и серверная, так и обычная память, поддержка LRDIMM незивестна |
...
| VRM | 6 фаз | [Более подробное описание  в вк](https://vk.com/@2485616-sistema-pitaniya-cpu-kitaiskih-2011-3-materinskih-plat) |
| Чипсет | C612 | |
| Память | DDR4 UDIMM/ECC/ECC REG/ | Т.Е Подходит как и серверная, так и обычная память, поддержка LRDIMM незивестна |
