...
| Звук | Realtek ALC892 |  |
| Sata | 8xSata 3.0(6Gb/S) из них 6(неизвестно какие) поддерживают Intel RAID 0/1/5/10 |  | 
| M2/Msata-miniPCI-E | 1 NVME PCI-E 3.0 x4 1x Msata-miniPCI-E WIFI | Поддержка Sata M2 SSD неизвестна, поддерживаемые размеры 2242, 2260, 2280, в слот miniPCI-E/MSata возле SATA портов можно установить только WIFI/WIFI+Bluetooth адаптеры, MSata SSD вероятнее всего работать не будут |
