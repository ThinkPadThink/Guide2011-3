...
*Если есть пожелания по улучшению гайда, пишите __Pull Request__  либо создавайте Issues и там будем обсуждать. *
...
| Питальник (VRM) | Контроллер: ISL6376, Транзисторы: QN3103 и QN3107x2 | Дроссели: R33, Конденсаторы: YTF  270uF 16Vx4/YTF 820uF 2.5Vx8 |
| Чипсет | C612 | |
...
|---|---|---|
| UEFI/BIOS | Классический AMI | Модбиос есть |
 ...
 **HUANANZHI X99-AD4 v2:**

| Характеристики | HUANANZHI X99-AD4 v4 | |
|---|---|---|
| UEFI/BIOS | Классический AMI | Наличие модбиоса пока неизвестно |
| Примечание | Описание на сайте [HUANAZHI](http://www.huananzhi.com/html/1/149/150/540.html)  | Данная плата появилась осенью 2020 года, аналогична AD3 но с DDR4  |
| Форм-фактор и размеры | ATX 283x215 мм  |  |
| Поддержка ЦПУ | Xeon E5 v3/Xeon E5 v4/i7: 5820k, 5930k, 5960x, 6800k, 6850k, 6900k, 6950x  |  |
| Чипсет | C612 | |
| Память | **Только DDR4** UDIMM/ECC/ECC REG/ | Т.Е Подходит как и серверная, так и обычная память, поддержка LRDIMM неизвестна |
...
| Комплектация | Возможно Плата, 2 Sata кабеля, заглушка задней панели I/O, диск с драйверами, возможно кольцо с переходником под крепление AMD и винты, инструкция и гарантия  |  |
 ...
 ![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/Huananzhi%20X99-AD4_1.jpg?raw=true)
...
| Частоты памяти | DDR4: 1866/2133/2400 |  |
| Максимальный поддерживаемы объём памяти | 256Gb | 8 планок по 32GB |
| Подключение вентиляторов | 5=3x 3PIN+2x 4PIN |  |
| Сеть | Realtek RTL8111H 1000/100/10 Mbit |  |
| Звук | Realtek ALC892 |  |
| Sata | 8xSata 3.0(6Gb/S) из них 6(неизвестно какие) поддерживают Intel RAID 0/1/5/10 |  | 
...
| Характеристики | Jingsha X99-E8I |  |
|---|---|---|
| UEFI/BIOS | Классический AMI | Клон материнка Huananzhi X99-F8 |
| Примечание |  |  |
| Форм-фактор и размеры | ATX 283x215 мм  |  |
| Поддержка ЦПУ | Xeon E5 v3/Xeon E5 v4/i7: 5820k, 5930k, 5960x, 6800k, 6850k, 6900k, 6950x |  |
| VRM |  6 фаз |  |
...
| Комплектация | Плата, 2 Sata кабеля, диск с драйверами, возможно кольцо с переходником под крепление AMD и винты, инструкция и гарантия  |  |
  ...
  ![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/Jingsha%20X99-E8I.png?raw=true)
...
MB X99 (USB 3.0 / SATA3 / PCI-E NVME M.2 SSD / ECC REG RAM DDR3 2 Channel). Здесь за 62,5$ вы получаете двухканальную плату со слотами DDR3. На данный момент это самые доступная плата с памятью DDR3! 
 ...
 По другим платам от китайцев пока ничего не известно.
  ...
  ### Не рекомендуемые платы к покупке:
 
<details>
<summary> <b> [Не рекомендуемые платы к покупке] </b> </summary>
  
  
  **JingSha X99-GT на чипсете Intel® B85**
  
![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/JingSha%20X99-GT.jpg?raw=true)

  **Machinist, Aterminer, Kllisre ZX-MINX9D4 v1.2**
  
![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/ZX-MINX9D4.jpg?raw=true)

Так же существует клон Huananzhi X99-8M, дизайн похож на плату выше
...
![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/case%20dell%20t5810.png?raw=true)
 ...
 <details>
<summary> <b> [Колхозинг платы T5810 от автора гайда] </b> </summary>
 
Установка охлаждения:

Изи левл: Необходимо кольцо переходник с сокета LGA 2011/2011-3 NARROW на AMD, 4 болта m4 30 мм они же DIN 965, 4 гайки м4 и пластиковая карта.

Ставим на плату кольцо, под отверстия для охлада в сокетной рамке кладём разрезанную пластиковую карту, шлицами под плату устанавливаем винты и крепим кольцо при помощи гаек. После этого уже можно крепить охлаждение на цпу.

Хард левл: делаем сами колхозное крепление для вашего охлада.

Подключение вентиляторов к материнской плате: 

Покупаем на али подобные удлинители: 

 ![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/fan_udlenitel.jpg)

 Далее по инструкции на коннекторе который будем подключать к плате меняем 1 и 3 пины местами. После этого из платы можно извлечь делловские пластиковые колпачки разъёмов и спокойно подключать наши удлинители, на другом конце (мама) у нас обычный стандартный 4 pin разъём куда можно цеплять обычные вентиляторы. 4 и 5 разъёмы на плате имеют одинаковую распиновку, так что данный трюк подходит для всех разъёмов. Чтобы удлинители лучше держались их можно посадить на термоклей. Учтите что не все вентиляторы нормально работают на данной плате, некоторые могут не работать. 
 
 ![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/dellFan.jpg?raw=true)
 
Фронт панель: 

Изи вариант: покупка оригинальной делловской панели, с ней у вас будет меньше всего гемора.

Хард вариант: колхоз, см ниже. 

Питание платы:

Питание ЦПУ: нужен 4+4 pin. Его нужно просто вставить в 10 pin разъём, защёлка провода с блока питания должна смотреть на плату т.е. жёлтые провода должны быть быть ближе к сокету, чёрные к краю платы. Одна из частей коннектора будет вставляться в разъём туго, это нормально. 

Питание материнской платы:
 
В любом случае понадобится переделка стандартного разъёма с блока питания, либо напрямую либо через переходник-удлинитель. 

 Изи вариант: используем одну плату преобразователь
 
 На али покупаем данный преобразователь MT3608:
 
  ![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/MT3608.jpg?raw=true)

 А также разъём для удлинителя и провода, ну и паяльник, припой, флюс и мультиметр если у вас этого нет. ь   
 
 

Далее собираем по данной фотографии переходник:

 ![](https://github.com/ThinkPadThink/Guide2011-3/blob/master/dellPower.jpg?raw=true)
 
 После этого запускаем блок питания без подключения платы, и проверяем напряжение на всех разъёмах. И при необходимости подкручиваем на приобразователе для получения 12в на дежурке. Так как 24 контактный разъём требует больше 12 вольтовых линий то можно как вариант их запараллелить от имеющегося в стандартном разъёме 24 пин либо же брать дополнительные 12вольтовые линии с PCI-E разъёма от видеокарты. Ну или из разъёма для питания цпу.
 
 
 Хард вариант: покупаем отдельный блок питания на 12в и запитываем либо отдельно либо через разъём на обычном блоке питания на пк и так же делаем переходник. 
 Кому как удобно.
 
 Всё, колхозинг закончен. 
 
 Для первого старта возможно понадобится оперативная память из листа совместимости, так как в старых версиях UEFI/BIOS зашито мало поддерживаемых планок памяти. После обновления UEFI/BIOS вариантов для выбора у вас будет больше. Но в любом случае подходит только DDR4 ECC REG 2133/2400, будут ли работать более высокие частоты не знаю. 
 UEFI/BIOS можно обновлять напрямую из под Windows. Драйвера для платы есть на сайте Dell.
 
 NVME SSD можно установить через переходник на PCI-E слот. Но будет ли загружаться с него ОС не знаю. 
